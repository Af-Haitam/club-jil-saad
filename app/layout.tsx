...
export const metadata: Metadata = {
  ...
  /**
   * إثبات ملكية الموقع في Google Search Console.
   *
   * الرمز يأتي من حساب صاحب النادي لا منّي، فيُقرأ من متغيّر بيئة: إن غاب
   * لم يُكتب الوسم أصلًا، ولا يُترك وسمٌ فارغٌ يُربك المدقّقين.
   *
   * ⚠ وهذا الوسم **لا يُدخل الموقع في نتائج البحث**. هو يُثبت الملكية فقط،
   * ثمّ يأتي الإدراج بطلب الفهرسة من داخل Search Console — وذاك فعلٌ لا
   * تفعله شيفرة.
   */
