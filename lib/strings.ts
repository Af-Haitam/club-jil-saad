...
export const strings = {
  ...
  app: {
    ...
    downloadMeta: "ملفّ APK · {size} ميغابايت",
    ...
    step3Title: "ثبّته",
    step3Body:
      "قد يعترض هاتفك مرّة أو مرّتين — الشاشتان أدناه توضّحان ما تضغط في كلٍّ منهما.",
    step4Title: "افتحه وسجّل دخولك",
    step4Body: "بنفس البريد وكلمة السرّ اللذين تستعملهما في الموقع.",

    warnHeading: "شاشتان قد تظهران — وكلتاهما طبيعية",
    warnLead:
      "أندرويد يعرضهما لكلّ تطبيقٍ لا يأتي من متجر Play. تطبيق النادي خارج المتجر عن قصد: النشر هناك يُكلّف مالًا، والنادي لا يجمع اشتراكات.",
