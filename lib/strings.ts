...
export const strings = {
  ...
  // ── صفحتا الخطأ ──
  // بلا هاتين تعرض Next صفحتها الافتراضية، وهي إنجليزية على صفحةٍ كلّها
  // عربية — يقرؤها العضو فيظنّ الموقع مكسورًا لا أنّ طلبًا تعثّر.
  errorTitle: "تعثّر شيءٌ ما",
  errorBody: "لم يكتمل تحميل هذه الصفحة. أعد المحاولة، فإن تكرّر فأبلغ المشرف.",
  errorRetry: "أعد المحاولة",
  errorHome: "العودة إلى الرئيسية",
  notFoundTitle: "لا توجد هذه الصفحة",
  notFoundBody: "الرابط الذي فتحته لا يشير إلى شيء — لعلّه تغيّر أو كُتب خطأً.",
  ...
  manage: {
    ...
    // ── الدليل ──
    guideTitle: "دليل الإدارة",
    guideLead:
      "كيف يُدار النادي من هذه اللوحة — بالترتيب الذي تحتاجه فعلًا، من قبول العضو إلى وصول التنبيه إلى هاتفه.",
    guideToc: "فهرس الدليل",
    guideGotchas: "ما يفاجئ",
    guideGotchasLead: "أشياء تعمل كما صُمِّمت، لكنّها تُربك أوّل مرّة. كلّ واحدةٍ منها وقعت فعلًا.",
    guideBack: "← رجوع إلى الإدارة",
    navGuide: "الدليل",

    // ── سجلّ الأخطاء ──
    errorsTitle: "سجلّ الأعطال",
    errorsLead: "ما فشل في الخادم دون أن يظهر لأحد — المهمّة اليومية، والتنبيهات، والنسخ الاحتياطي.",
    errorsNone: "لا أعطال مسجَّلة",
    errorsPending: "يظهر بعد تطبيق ملفّ الترحيل 0010.",
