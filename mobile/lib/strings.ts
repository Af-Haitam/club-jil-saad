...
export const s = {
  ...
  quiz: {
    ...
    multiHint: "لهذا السؤال أكثر من جوابٍ صحيح — اختر كلّ ما تراه صوابًا",
    movingToArchive: "ينتقل إلى «الأسئلة السابقة»…",
    closed: "أُغلق هذا السؤال",
    archiveTitle: "الأسئلة السابقة",
    archiveEmpty: "لم يمرّ سؤالٌ بعد",
    archiveLink: "الأسئلة السابقة",
    scoreTitle: "نقاطي",
